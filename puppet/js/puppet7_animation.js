...
document.getElementById('playbutton').onclick = function () {
	...
	audio.currentTime = Math.floor(Math.random() * (387));
	audio.loop = true;
    audio.play();
