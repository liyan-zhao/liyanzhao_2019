...
document.getElementById('playbutton').onclick = function () {
	...
	for (var i = 0; i < poses; i++) {
		...
		// .to({x: posX[i], y: posY[i]}, Math.floor(Math.random() * (1000 + 1) ) + 1000)
		// .delay(Math.floor(Math.random() * (900 + 1) ) + 100)
